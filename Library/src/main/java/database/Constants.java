...
public class Constants {
    ...
    public static class Rights {
        ...
        public static final String[] CUSTOMER_RIGHTS = new String[]{BUY_BOOK};
        public static final String[] EMPLOYEE_RIGHTS = new String[]{CREATE_BOOK, DELETE_BOOK, UPDATE_BOOK, SELL_BOOK};
        public static final String[] ADMIN_RIGHTS = new String[]{CREATE_USER, DELETE_USER, UPDATE_USER};
    }
}
